...
<head>
    ...
    <title>Emprendimientos | Administrador</title>
...
<body>
    ...
    <section class="view">
        <div class="imagenTop bg-image">
            <img src="../img/visitante1.jpg" class="w-100" id="imgCentral" alt="" />
    ...
    <section class="contenederEmprendis"><br>
        <div class="container-fluid">
            ...
            <div id="TextoCentro"><br>
                ...
                <div class="container">
                    <form action="Administradore.php" method="GET">
                        ...
                        <div class="container">
                            <div class="row" id="Categ">
                                <div class="form-group col-md-2">
                                    <a href="Administradore.php?categoria=Intelectual"><i class="bi bi-book"></i>
                                        <label for="Intelectual">Intelectual</label></a>
                                </div>
                                <div class="form-group col-md-2">
                                    <a href="Administradore.php?categoria=Tecnología"><i class="bi bi-cpu"></i>
                                        <label for="Tecnología">Tecnología</label></a>
                                </div>
                                <div class="form-group col-md-2">
                                    <a href="Administradore.php?categoria=Útiles">
                                        <i class="bi bi-brush"></i>
                                        <label for="Útiles">Útiles</label></a>
                                </div>
                                <div class="form-group col-md-2">
                                    <a href="Administradore.php?categoria=Material">
                                        <i class="bi bi-archive"></i>
                                        <label for="Material">Material</label></a>
                                </div>
                                <div class="form-group col-md-2">
                                    <a href="Administradore.php?categoria=Ropa">
                                        <i class="bi bi-eyeglasses"></i>
                                        <label for="Ropa">Ropa</label></a>
                                </div>
                                <div class="form-group col-md-2">
                                    <a href="Administradore.php?categoria=Comida">
                ...
                <form action="Administradore.php" method="GET">
                    ...
                    <div class="row g-3 d-flex justify-content-center">
                        ...
                        <div class="form-group col-md-10">
                            ...
                            <a href="Administradore.php"><button class="BtnFiltro2">Limpiar filtros</button></a>
                        </div>
                    </div>
                </form><br><br>
            </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <?php
                    include '../emprendimientos/BuscadorEmprendiAdmi.php';
                    $contaVueltas = 0;
                    ...
                    ?>
                        <div class="masCards col-lg-4 col-md-6 col-sm-12 " id="tajertaEmprendi">
                            <div class="card h-100 " id="contenidoCardEmprendi">
                                ...
                                <div class="BtnVerMas">
                                    <a class="btn VerMas" href="Veremprendimientoadm.php?idPublicacion=<?php echo $filasPublicaciones['idPublicacion'] ?>"> Ver más</a>
                                </div>
