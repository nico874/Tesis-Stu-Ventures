...
$sql = "SELECT * from chats_correspon Where De ='$_SESSION[idUsuarioAdmin]' AND ActivoChats BETWEEN 0 AND 2 ORDER BY idCorres DESC";
...
$sqlMensajesTotal = "SELECT COUNT(*) idCorres from chats_correspon Where De = '$_SESSION[idUsuarioAdmin]'  ";
  ...
  <section class="contenedorChats"><br>
    <div class="container-fluid">
      ...
      <div id="TextoCentro"><br>
        <p id="textoCenter3">En esta sección podrás ver tus interacciones con los emprendedores, recuerda que si entras al chat dejarás de tener pendiente el o los mensajes.</p>
        <div class="container">
          <form action="MensajesAdmin.php" method="GET">
                    ...
                    <div class="col-md-8">
                      <div class="card-body">
                        ...
                        <div class="row ">
                          <div class="col-md-4 ">
                            Emprendimiento:
                            <div class="name"><?php echo $filaPubli['Titulo'] ?> </div><br>
                          </div>
                          ...
                          <div class="col-md-4 ">
                            <a class="btn VerMaschat" style="margin-bottom: 10px;" href="Veremprendimientoadm.php?idPublicacion=<?php echo $filaPubli['idPublicacion'] ?>" class="list-group-item media border-0 ">Ver Emprendi </a><br>
                            <a class="btn VerMaschat" style="margin-bottom: 10px;" href="ChatAdmin.php?idCorres=<?php echo $filasCorres['idCorres'] ?>" class="list-group-item media border-0 ">Chatear</a>
