...
$idPubli = $_GET["idPubli"];
    ...
    $SqlValora = "INSERT INTO valoracion (Cantidad, Usuario_idUsuario, Publicacion_idPublicacion) VALUES ('$estrellas', '$_SESSION[idUsuario]', '$idPubli')";
    ...
    if (mysqli_query($conexion, $SqlValora)) {
        ...
        header("Location:../visitante/VerEmprendimientovi.php?idPublicacion=$idPubli");
    } else {
        echo "Error";
    }
