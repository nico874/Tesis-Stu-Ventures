...
if ($TituloEmprendi != "") {
    $sqlEmprendiFecha = "SELECT * from publicacion Where titulo LIKE '%" . $TituloEmprendi . "%' AND WEEK(fecha)=$semana ORDER BY Valoracion desc LIMIT 10 ";
...
<head>
    ...
    <title>Top Semanal | Visitante</title>
                ...
                ?>
                    <div class="card col-lg-6 col-md-6 col-sm-12 " id="tajertaEmprendi2">
                        ...
                        <div class="card-body">
                            ...
                            <div class="BtnVerMas">
                                <a class="btn VerMasTop" href="Veremprendimientovi.php?idPublicacion=<?php echo $filaFecha['idPublicacion'] ?>"> Ver más</a>
                            </div>
