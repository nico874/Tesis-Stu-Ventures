...
$sql = "SELECT * from chats_correspon Where De ='$_SESSION[idUsuarioAdmin]'";
...
$sqlUpdateChat = "UPDATE chat set Estado = '0' WHERE Recibe_Usuarioid= '$_SESSION[idUsuarioAdmin]' AND idCorres = '$idCorres'";
...
<body>
    ...
    <section class="contenedorChat"><br>
        <div class="container">
            <div class="person2">
                <a href="MensajesAdmin.php"> <i class="bi bi-arrow-left-circle"></i> </a>
            </div>
                ...
                if (isset($_GET['idCorres'])) {
                    ...
                    if (mysqli_num_rows($resultChat) == 0) {
                        ...
                        while ($filasChat = mysqli_fetch_array($resultChat)) { ?>
                            ...
                            <?php if ($filasChat['Envia_Usuarioid'] == $_SESSION['idUsuarioAdmin']) { ?>
                    ...
                    <?php if ($acciDesabi == "") { ?>
                        <div class="input-group-prepend">
                            <div class="row" id="MiInput">
                                <textarea name="mensaje" class="form-control" id="exampleFormControlTextarea1" placeholder="Escribe tú texto aqui..." required style="max-height: 90px;"></textarea>
