    ...
    <section class="contenederEmprendis"><br>
        <div class="container-fluid">
            ...
            <div id="TextoCentro"><br>
                <p id="textoCenter3">¡Top semanal de los 10 emprendimientos <b id="LinksEstas">MEJORES VALORADOS!</b> Recuerda que para ver más del emprendimiento <a href="Login.php" target="_blank"><b id="btnregistro">debes inciar sesión.</b></a></p>
                <br>
            </div>
            <div class="container">
                <!--TARJETAS-->
                    ...
                    ?>
                        <div class="card col-lg-6 col-md-6 col-sm-12  " id="tajertaEmprendi2">
                            ...
                            <div class="card-body">
                                ...
                                <div class="BtnVerMas">
                                    <a class="btn VerMasTop" target="_blank" href="Login.php" onclick=" return ConfirmarVermás()"> Ver más...</a>
                                </div>
