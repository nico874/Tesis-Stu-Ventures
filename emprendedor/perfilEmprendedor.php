                        ...
                        <div class="col-md-12" id="border1">
                            <div class="row">
                                ...
                                <div class="col-md-6" id="TexFull">
                                    <a href="PerfilEmprendedor.php" class="link">MIS DATOS</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12" id="border1">
                            <div class="row">
                                ...
                                <div class="col-md-6" id="TexFull">
                                    <a href="CambioContraseñaEm.php">CAMBIAR CONTRASEÑA</a>
                                </div>
                            </div>
                        </div><br>
                        ...
                        <form action="ActualizarEmp.php" method="POST" class="needs-validation " id="Perfil" novalidate>
                            <div class="row">
                                <div class="col-md-12" id="InputsForms1">
                                    <p class="textoCentra">Estos son <b id="LinksEstas">tus datos</b>, recuerda que no pueden ser vistos por otros usuarios.</p><br>
                                </div>
                                <div class="col-md-12" id="InputsForms1">
                                ...
                                <div class="col-md-12" id="InputsForms">
                                    ...
                                    <input type="text" name="direc" value="<?php echo  $columna3["Direccion"]; ?>" id="direc" class="form-control" required>
                                    <span id="icon">
                                        <i class="bi bi-pen" title="Campo editable"></i>
                                    </span>
                                </div>
                                <div class="col-md-12" id="InputsForms">
                                    ...
                                    <input type="text" name="comuna" value="<?php echo  $columna3["Comuna"]; ?>" id="comuna" class="form-control"  required>
                                    <span id="icon">
                                        <i class="bi bi-pen" title="Campo editable"></i>
                                    </span>
                                </div>
                                ...
                                <div class="col-md-12" id="InputsForms">
                                    <label for="Insta" class="form-label"> Instagram<b id="rojo">*</b></label>
                                    <input type="text" name="Instagram" value="<?php echo  $columna["Instagram"]; ?>" id="Insta" class="form-control">
                                    <span id="icon">
                                        <i class="bi bi-pen" title="Campo editable"></i>
                                    </span>
                                </div>
                                <div class="col-md-12" id="InputsForms">
                                    <label for="Facebook" class="form-label"> Facebook<b id="rojo">*</b></label>
                                    <input type="text" name="Facebook" value="<?php echo  $columna["Facebook"]; ?>" id="Face" class="form-control">
                                    <span id="icon">
                                        <i class="bi bi-pen" title="Campo editable"></i>
                                    </span>
                                </div>
