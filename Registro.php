        ...
        <div class="row">
            ...
            <div class="col-lg-7 col-md-12 col-sm-12" id="inicio2">
                ...
                <form action="bd/insertarUser.php" class="row g-3 needs-validation " id="formRegistro" novalidate>
                    <p class="textoCentra">Mediante tu registro, podrás acceder a Stu-Ventures sin que se soliciten
                        nuevamente tus datos para poder navegar y interactuar.</p>

                    <p class="text-danger small textoCentra">*Completa los datos solicitados según el tipo de usuario que
                        serás y ¡se parte de Stu-Ventures!</p>
                    <div class="col-md-12 ">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6" id="registro">
                        ...
                        <div class="col-md-12">
                            <input type="text" name="Direccion" value="" id="Dirección" class="form-control" placeholder="Dirección" required>
                        </div>
                        <div class="col-md-12">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6" id="registro">
                        ...
                        <div class="col-md-12">
                            <input type="numeric" name="Telefono" value="" id="Telefono" pattern="[0-9]{9}" class="form-control" placeholder="Número de contacto" required title="Ingrese su número de contacto con el 9">
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <input type="password" name="Contrasena" value="" id="Contraseña" class="form-control" placeholder="Contraseña" required>
                        </div>
