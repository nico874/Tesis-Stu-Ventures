...
<body>
    ...
    <section class="contenidoPerfil"> <br>
        <div class="container-fluid">
            <div class="container">
                <div class="person2">
                    <a href="PerfilUsuario.php"> <i class="bi bi-arrow-left-circle"></i> </a>
                </div>
                        ...
                        <div class="col-md-12" id="border1">
                            <div class="row">
                                ...
                                <div class="col-md-6" id="TexFull">
                                    <a href="PerfilUsuario.php">MIS DATOS</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12" id="border1">
                            <div class="row">
                                ...
                                <div class="col-md-6" id="TexFull">
                                    <a href="CambioContraseñaVi.php" class="link">CAMBIAR CONTRASEÑA</a>
                                </div>
                            </div>
                        </div><br>
                            ...
                            <form action="" method="GET" class="needs-validation " novalidate>
                                ...
                                <div class="d-flex justify-content-center">
                                    <button class="btnChatear " type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
                                        Contactar <i class="bi bi-chat-dots" id="iconWhite"></i>
                                    </button>
                                </div>
                        ...
                        <form action="ActualizarVisit.php" method="POST" class="needs-validation " id="Perfil" novalidate>
                            <div class="row">
                                ...
                                <div class="col-md-12" id="InputsForms">
                                    <label for="Contraseña" class="form-label">Mi contraseña actual es<b id="rojo">*</b>:</label>
